...
|---|---|---|
| `kyhieuhdon` | Ký hiệu hóa đơn | `str` |
| `sohd` | Số hóa đơn | `str` |
| `ngaynhap` | Ngày phát hành | `date` |
| `tendt` | Tên người bán | `str` |
| `msthue` | Mã số thuế người bán | `str` |
| `diengiai` | Mặt hàng / dịch vụ | `str` |
| `von` | Doanh số chưa thuế | `Decimal` |
| `suatthue` | Thuế suất | `Decimal` (0.08 / 0.10) |
| `thue` | Thuế GTGT | `Decimal` |
...
```
s3://invoices/{năm}/{tháng:02d}/{tên_khách_hàng}/{sohd}.pdf
s3://invoices/{năm}/{tháng:02d}/{tên_khách_hàng}/{sohd}.xml
